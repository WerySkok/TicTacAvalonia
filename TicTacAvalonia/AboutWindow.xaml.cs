...
namespace TicTacAvalonia
{
    public class AboutWindow : Window
    {
        ...
        private void InitializeComponent()
        {
            ...
            TextRow1 = this.FindControl<TextBlock>("TextRow1");
            TextRow2 = this.FindControl<TextBlock>("TextRow2");
            TextRow3 = this.FindControl<TextBlock>("TextRow3");
            TextRow4 = this.FindControl<TextBlock>("TextRow4");
            TextRow5 = this.FindControl<TextBlock>("TextRow5");
